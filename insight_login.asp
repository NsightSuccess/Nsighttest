...
<body link="#000080" vlink="#000080" alink="#000080" style="margin: 8">
    <div class="auto-style1">
<img alt="" src="gfx/400dpiLogo.jpg" style="height: 175px; width: 500px"><br >
...
<!--<a href="https://forms.office.com/Pages/ResponsePage.aspx?id=GRQzKuiOFEWas24z3Omv06xuk6UY4ztGnjsly_IeuU9UMjJSV1NOWVBMUDk5OTdJVlgzU1hKVzFQQS4u"><img alt="" src="gfx/btn_taketest_360.gif" class="style1"></a><br >-->
...
<table border="1" cellpadding="5" cellspacing="5" style="width: 550px; height: 290px">
  ...
  <tr>
    ...
    <td bgcolor="#cccc99" class="auto-style2">
   <!-- 
-->  
 <script Language="JavaScript" Type="text/javascript"><!--
...
//--></script>
	...
	<form method=post action="insight_login.asp?action=logon" name=FrontPage_Form1 onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" style="width: 350px">
      ...
      <font face="Courier">
        <input maxlength="100" name="email" size="50" style="width: 300px"></font>
      <font size=1><br>
      </font><font face="Courier New, Courier, mono" size="2">Password:</font><font color="#ff0000">*</font><br>
      <font face="Courier">
        <input maxlength="35" name="password" size="30" 
          type="password" style="width: 200px"><br />
        </font><br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font face="Courier">
...
<%
fromWho="admin@directionalnsight.com"						'From Penny
toWho="admin@directionalnsight.com"							'To Customer
Subject = "New Login"
HTMLBody = "Testing Email Fix"
...
<table border="1" cellspacing="0">
  <tr>
    <td colspan="3" width="480"><font face="Verdana" size="2">Enter your email address and we will send you your
      ...
      to take an assessment, you need to get the Authorization ID from the company who gave it
      to you.</font>
    </td>
  </tr>
  <tr>
...
<blockquote>
  <blockquote>
    ...
    invalid logon. If you are an assessments taker, please check your Authorization ID and try
...
toaddr2=rs1("ccName")    'CC Email 1 of Company Acct
...
<blockquote>
  <blockquote>
    ...
    sent you an email to your <i><%=towho%></i> that contains your password. Please wait a moment for this
...
<table width="50%" border="0" cellspacing="5" cellpadding="5">
  <tr> 
    <td width="64%" height="242"> 
      <p align="justify" class="auto-style3">If you require special accommodations or are uncomfortable 
        ...
        operations are all that are required to respond to NSight assessment questions.</p>
      <p align="justify" class="auto-style3">Upon your acceptance of the following terms, please proceed 
        by entering the authorization code. Otherwise, Contact Us before proceeding. Thank you in advance for the time you will spend responding to the assessment 
        questions.</p>
      <p align="justify" class="auto-style3">In consideration for being permitted to complete NSight, 
        ...
        results to be given directly to the company that has requested it. </p>
...
function FrontPage_Form4_Validator(theForm)
{
  ...
  if (theForm.password.value == "")
  {
      alert("Please enter a value for the \"Authorization ID\" field.");
    theForm.password.focus();
    return (false);
  }
  ...
  {
    alert("Please enter at least 8 characters in the \"Authorization ID\" field.");
    theForm.password.focus();
    return (false);
  }
  return (true);
...
<form method="POST" action="insight_login.asp?action=logon" name="FrontPage_Form4" target="_self" onsubmit="return FrontPage_Form4_Validator(this)" language="JavaScript">
      ...
      Contact your company's primary contact to reconfirm your authorization code.</font></p>
      </td>
  </tr>
</table>
</center>
...
'    .Item(cdoSendUserName) = "gtalford@ftc-i.net"
'    .Item(cdoSendPassword) = "Themas1950"
'    .Item(cdoSMTPServerPort) = 587 '25 '465 '587
'    .Item(cdoSMTPconnectiontimeout) = 30	
'    .Item(cdosmtpAuthenticate) = 1
'    .Item(cdoSMTPusessl) = true 
'
    .item(cdosmtpserver) = "smtp.gmail.com"
	.item(cdosendusername) = "pennykreynolds1953@gmail.com"
	.item(cdosendpassword) = "sissybird33"
	.item(cdosmtpserverport) = 587 '25 '465 '587
    .item(cdosmtpconnectiontimeout) = 30	
 	.item(cdosmtpauthenticate) = 1
...
'	.Item(cdoSendUserName) = "gerald@nsightsuccess.com"
'	.Item(cdoSendPassword) = "G12t30@50"
'	.Item(cdoSMTPServerPort) = 25 '25 '465 '587
'   .Item(cdoSMTPconnectiontimeout) = 30	
'	.Item(cdosmtpAuthenticate) = 1
'   .Item(cdoSMTPusessl) = true 
