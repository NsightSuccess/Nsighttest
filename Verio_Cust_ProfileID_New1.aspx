...
<form id="form1" runat="server">
		...
		<p align="center">
            Start Date: <asp:TextBox id="TextBox1" runat="server" Width="150px" 
                CssClass="style1">1/1/2023</asp:TextBox>
            ...
            End Date: &nbsp;&nbsp;<asp:TextBox id="TextBox2" runat="server" Width="150px" 
                CssClass="style1">12/31/2029 11:59:59 PM</asp:TextBox>
		...
		&nbsp;&nbsp;&nbsp;
			...
			<div class="style1">
				...
				<Columns>
					<asp:HyperLinkField DataNavigateUrlFields="Expr1" DataNavigateUrlFormatString="insight_mgmt.asp?action=results2&amp;ProfileID={0}" DataTextField="Expr1" DataTextFormatString="{0}" HeaderText="ServerScore" SortExpression="Expr1" Target="_blank" />
    				<asp:hyperlinkfield DataNavigateUrlFields="ProfileID" DataNavigateUrlFormatString="/example1.aspx?ProfileID3={0}" DataTextField="ProfileID" DataTextFormatString="{0}" HeaderText="LocalScore" SortExpression="ProfileID" Target="_blank">
...
--%>					</asp:hyperlinkfield>
		...
		<div class="style1">
			<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:insi40ConnectionString %>" 
                ...
                SelectCommand="SELECT ProfileID, ProfileID AS Expr1, DateTaken, ProductID, Salutation, First, Last, Email, Position, pwUsed, FirstName, LastName, Company, PDesc FROM ProfileID_Customer WHERE (DateTaken &gt;= @DateTaken) AND (DateTaken &lt;= @DateTaken2) ORDER BY ProfileID DESC">
				<SelectParameters>
